...
<html>
		...
		<div class="gtco-container">
			...
			<div class="row">
				<div class="col-sm-4 col-xs-12">
					<div id="gtco-logo"><a href="index.html">Travellink <em>.</em></a></div>
				</div>
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="<?php echo base_url(); ?>assets/images/img_1.jpg" class="fh5co-card-item image-popup">
						...
						<div class="fh5co-text">
							<h2> Surabaya </h2>
							<p>2nd Largest Metropolitan in Indonesia</p>
	...
	<div class="gtco-cover gtco-cover-sm" style="background-image: url(<?php echo base_url(); ?>assets/images/img_bg_2.jpg)"  data-stellar-background-ratio="0.5">
		<div class="overlay"></div>
